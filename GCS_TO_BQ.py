...
with DAG(
    ...
    load_data_to_bq = GCSToBigQueryOperator(
        ...
        bucket='ath72salyt',  # The name of the GCS bucket
        source_objects=['data.csv'],  # Path to your file(s) in GCS
        destination_project_dataset_table='tt-sandbox-001.composer.composer02',  # BigQuery destination (project.dataset.table)
